...
do
	...
	cp ~/Documents/projects/bosonic_matrix_models/data/1.0/L24N16/$temp/Output_Files/Results/*.png ./t$temp/Results/

done

cp ~/Documents/projects/bosonic_matrix_models/data/1.0/L24N16/Temperature_Plots/*.png ./Obs/Results/
