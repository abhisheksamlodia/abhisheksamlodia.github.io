...
T=('1.875' '1.9' '1.925' '1.95' '1.975' '2.0' '2.025' '2.05' '2.075' '2.1' '2.125')
for temp in "${T[@]}"
do
	rm -rf t$temp
	mkdir t$temp
	...
	cp ~/Documents/Coding_Projects/BMN_Matrix_Model/BMN_Bosonic/New_Analysis/0.0001/L24N8/$temp/Output_Files/Results/*.png ./t$temp/Results/

done

cp ~/Documents/Coding_Projects/BMN_Matrix_Model/BMN_Bosonic/New_Analysis/0.0001/L24N8/*.png ./Obs/Results/
